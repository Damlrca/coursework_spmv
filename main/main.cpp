...
double mx_diff_scs__4_2 = 0;
double mx_diff_scs__8_2 = 0;
double mx_diff_scs_16_2 = 0;
double mx_diff_scs_32_2 = 0;
double mx_diff_scs__4_4 = 0;
double mx_diff_scs__8_4 = 0;
double mx_diff_scs_16_4 = 0;
double mx_diff_scs_32_4 = 0;
double mx_diff_scs__4_8 = 0;
double mx_diff_scs__8_8 = 0;
double mx_diff_scs_16_8 = 0;
double mx_diff_scs_32_8 = 0;
...
long long spmv_scs__4_2_time = numeric_limits<long long>::max();
long long spmv_scs__8_2_time = numeric_limits<long long>::max();
long long spmv_scs_16_2_time = numeric_limits<long long>::max();
long long spmv_scs_32_2_time = numeric_limits<long long>::max();
long long spmv_scs__4_4_time = numeric_limits<long long>::max();
long long spmv_scs__8_4_time = numeric_limits<long long>::max();
long long spmv_scs_16_4_time = numeric_limits<long long>::max();
long long spmv_scs_32_4_time = numeric_limits<long long>::max();
long long spmv_scs__4_8_time = numeric_limits<long long>::max();
long long spmv_scs__8_8_time = numeric_limits<long long>::max();
long long spmv_scs_16_8_time = numeric_limits<long long>::max();
long long spmv_scs_32_8_time = numeric_limits<long long>::max();
...
int main(int argc, char** argv) {
	...
	test_sell_c_sigma< 4, 2>(ite, threads_num, mtx_CSR, spmv_scs__4_2_time, mx_diff_scs__4_2);
	test_sell_c_sigma< 8, 2>(ite, threads_num, mtx_CSR, spmv_scs__8_2_time, mx_diff_scs__8_2);
	test_sell_c_sigma<16, 2>(ite, threads_num, mtx_CSR, spmv_scs_16_2_time, mx_diff_scs_16_2);
	test_sell_c_sigma<32, 2>(ite, threads_num, mtx_CSR, spmv_scs_32_2_time, mx_diff_scs_32_2);
	test_sell_c_sigma< 4, 4>(ite, threads_num, mtx_CSR, spmv_scs__4_4_time, mx_diff_scs__4_4);
	test_sell_c_sigma< 8, 4>(ite, threads_num, mtx_CSR, spmv_scs__8_4_time, mx_diff_scs__8_4);
	test_sell_c_sigma<16, 4>(ite, threads_num, mtx_CSR, spmv_scs_16_4_time, mx_diff_scs_16_4);
	test_sell_c_sigma<32, 4>(ite, threads_num, mtx_CSR, spmv_scs_32_4_time, mx_diff_scs_32_4);
	test_sell_c_sigma< 4, 8>(ite, threads_num, mtx_CSR, spmv_scs__4_8_time, mx_diff_scs__4_8);
	test_sell_c_sigma< 8, 8>(ite, threads_num, mtx_CSR, spmv_scs__8_8_time, mx_diff_scs__8_8);
	test_sell_c_sigma<16, 8>(ite, threads_num, mtx_CSR, spmv_scs_16_8_time, mx_diff_scs_16_8);
	test_sell_c_sigma<32, 8>(ite, threads_num, mtx_CSR, spmv_scs_32_8_time, mx_diff_scs_32_8);
	...
	cout << "mx_diff_scs__4_2       : " << mx_diff_scs__4_2 << endl;
	cout << "mx_diff_scs__8_2       : " << mx_diff_scs__8_2 << endl;
	cout << "mx_diff_scs_16_2       : " << mx_diff_scs_16_2 << endl;
	cout << "mx_diff_scs_32_2       : " << mx_diff_scs_32_2 << endl;
	cout << "mx_diff_scs__4_4       : " << mx_diff_scs__4_4 << endl;
	cout << "mx_diff_scs__8_4       : " << mx_diff_scs__8_4 << endl;
	cout << "mx_diff_scs_16_4       : " << mx_diff_scs_16_4 << endl;
	cout << "mx_diff_scs_32_4       : " << mx_diff_scs_32_4 << endl;
	cout << "mx_diff_scs__4_8       : " << mx_diff_scs__4_8 << endl;
	cout << "mx_diff_scs__8_8       : " << mx_diff_scs__8_8 << endl;
	cout << "mx_diff_scs_16_8       : " << mx_diff_scs_16_8 << endl;
	cout << "mx_diff_scs_32_8       : " << mx_diff_scs_32_8 << endl;
	...
	cout << "spmv_scs__4_2          : " << us_to_ms_string(spmv_scs__4_2_time) << "ms per iteration (minimum)" << endl;
	cout << "spmv_scs__8_2          : " << us_to_ms_string(spmv_scs__8_2_time) << "ms per iteration (minimum)" << endl;
	cout << "spmv_scs_16_2          : " << us_to_ms_string(spmv_scs_16_2_time) << "ms per iteration (minimum)" << endl;
	cout << "spmv_scs_32_2          : " << us_to_ms_string(spmv_scs_32_2_time) << "ms per iteration (minimum)" << endl;
	cout << "spmv_scs__4_4          : " << us_to_ms_string(spmv_scs__4_4_time) << "ms per iteration (minimum)" << endl;
	cout << "spmv_scs__8_4          : " << us_to_ms_string(spmv_scs__8_4_time) << "ms per iteration (minimum)" << endl;
	cout << "spmv_scs_16_4          : " << us_to_ms_string(spmv_scs_16_4_time) << "ms per iteration (minimum)" << endl;
	cout << "spmv_scs_32_4          : " << us_to_ms_string(spmv_scs_32_4_time) << "ms per iteration (minimum)" << endl;
	cout << "spmv_scs__4_8          : " << us_to_ms_string(spmv_scs__4_8_time) << "ms per iteration (minimum)" << endl;
	cout << "spmv_scs__8_8          : " << us_to_ms_string(spmv_scs__8_8_time) << "ms per iteration (minimum)" << endl;
	cout << "spmv_scs_16_8          : " << us_to_ms_string(spmv_scs_16_8_time) << "ms per iteration (minimum)" << endl;
	cout << "spmv_scs_32_8          : " << us_to_ms_string(spmv_scs_32_8_time) << "ms per iteration (minimum)" << endl;
